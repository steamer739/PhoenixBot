...
class CreateDialog(QtWidgets.QDialog):
    ...
    def setupUi(self, CreateDialog):
        ...
        CreateDialog.setFixedSize(647, 230)
        ...
        self.productType_box = QtWidgets.QComboBox(self.background)
        self.productType_box.setGeometry(QtCore.QRect(50, 20, 151, 21))
        self.productType_box.setStyleSheet("outline: 0;border: 1px solid #5D43FB;border-width: 0 0 2px;color: rgb(234, 239, 239);")
        self.productType_box.addItem("Product Type")
        self.productType_box.setFont(font)
        self.site_box = QtWidgets.QComboBox(self.background)
        self.site_box.setGeometry(QtCore.QRect(50, 70, 151, 21))
        ...
        self.input_edit.setGeometry(QtCore.QRect(250, 70, 151, 21))
        ...
        self.profile_box.setGeometry(QtCore.QRect(450, 70, 151, 21))
        ...
        self.proxies_box.setGeometry(QtCore.QRect(450, 120, 151, 21))
        ...
        self.monitor_edit.setGeometry(QtCore.QRect(50, 120, 61, 21))
        ...
        self.error_edit.setGeometry(QtCore.QRect(140, 120, 61, 21))
        ...
        self.addtask_btn.setGeometry(QtCore.QRect(250, 170, 151, 32))
        self.addtask_btn.setText("Add Task")
        self.maxprice_checkbox = QtWidgets.QCheckBox(self.background)
        self.maxprice_checkbox.setGeometry(QtCore.QRect(250, 120, 87, 20))
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(13*.75)
        font.setFamily("Arial")
        ...
        self.price_edit.setGeometry(QtCore.QRect(350, 120, 51, 21))
        ...
        self.taskcount_spinbox.setGeometry(QtCore.QRect(420, 175, 41, 21))
        ...
        self.site_box.addItem("Newegg")
        self.site_box.addItem("Nike")
        self.site_box.addItem("Adidas")

        self.productType_box.addItem("GPU")
        self.productType_box.addItem("CPU")
        self.productType_box.addItem("Shoes")
